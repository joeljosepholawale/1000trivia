...
router.post('/create-credits-bundle', authService.authenticate, authService.requireEmailVerification, async (req, res) => {
  try {
...
router.post('/create-entry-fee', authService.authenticate, authService.requireEmailVerification, async (req, res) => {
  try {
    const user = (req as any).user;
