...
router.post('/claim-daily', authService.authenticate, authService.requireEmailVerification, async (req, res) => {
  try {
    const user = (req as any).user;
...
router.post('/ad-reward', authService.authenticate, authService.requireEmailVerification, async (req, res) => {
  try {
    const user = (req as any).user;
...
router.post('/claim-ad-reward', authService.authenticate, authService.requireEmailVerification, async (req, res) => {
  try {
    const user = (req as any).user;
...
router.post('/refund', authService.authenticate, authService.requireEmailVerification, async (req, res) => {
  try {
    const user = (req as any).user;
