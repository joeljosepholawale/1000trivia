...
const slides: OnboardingSlide[] = [
  {
    ...
    description: 'Beantworte tausende spannende Fragen aus allen Wissensbereichen',
    icon: 'quiz',
    gradient: [theme.colors.primary[400], theme.colors.primary[600]],
  },
  {
    id: '2',
    title: 'Gewinne echtes Geld',
    description: 'Verdiene Punkte und tausche sie gegen echte Geldpreise ein',
    icon: 'attach-money',
    gradient: [theme.colors.success[400], theme.colors.success[600]],
  },
  {
    id: '3',
    title: 'Tritt an gegen andere',
    description: 'Kämpfe dich an die Spitze der Bestenliste und werde Champion',
    icon: 'emoji-events',
  ...
  },
  {
    ...
    description: 'Erhalte jeden Tag kostenlose Credits und schaue Werbung für Boni',
    icon: 'redeem',
    gradient: [theme.colors.info[400], theme.colors.info[600]],
  },
];
